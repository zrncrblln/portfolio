...
const CERTS = [
  ...
  {
    name: "Certified Data Center Technician (CDCT)",
    issuer: "CompTIA",
    icon: Server,
  },
  {
    name: "Professionalism (US English)",
    issuer: "Wadhwani Foundation",
    icon: Award,
  },
  {
    name: "Start-Up Mindset (US English)",
    issuer: "Wadhwani Foundation",
    icon: Lightbulb,
  },
  {
    name: "Outstanding Scholar - SPARK Technical Training (General Virtual Assistance 2.0)",
    issuer: "DICT",
    icon: GraduationCap,
  },
];
        ...
        <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {CERTS.map((cert) => {
            ...
            return (
              <div
                key={cert.name}
                className="scroll-reveal bg-card border border-border rounded-xl p-5 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md"
              >
