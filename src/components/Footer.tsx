    ...
    <>
      <footer className="border-t border-border py-8">
        <div className="content-wrapper flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
          <span>
            <span className="font-display font-bold text-foreground">ZC</span> · © 2025 Zoren Corbillon
          </span>
          <span className="text-xs">Designed & built with precision in the Philippines</span>
        </div>
      </footer>
